...
const Login = () => {
  ...
  return (
    ...
    border="1px solid gray">
        <Input mb='.5rem' placeholder='Enter Your Email' onChange={(e)=>setEmail(e.target.value)} value={email}/>
        <Input mb='.5rem' placeholder='Enter Your Password' onChange={(e)=>setPassword(e.target.value)} value={password}/>
