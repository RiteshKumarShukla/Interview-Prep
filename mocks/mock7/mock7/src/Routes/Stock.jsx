...
const Stock = () => {
    ...
    const handleBuy = (data) => {
        dispatch(buyStock(userId, { ...data, total: data.cost_per_share * qty }))
    }
    ...
    return (
        <>
            <Flex padding='1rem' bgColor={'black'} color='white' justifyContent={'space-evenly'}>
                <Text>Welcome to Stocks Section</Text>
